...
──────────────────────────────────────────────────────
Create "relation_stats_top200_en_de_ru_42k.tsv" file with columns:
    relation  count  proportion  quota  en  de  ru

Guarantees:
• Exactly 42 000 triples when quotas are summed.
...
TOP_M_FINAL      = 200
TARGET_TRIPLES   = 42_000
MIN_PER_REL      = 50
LANGUAGES        = ["en", "de", "ru"]
OUTPUT_STATS_TSV = "relation_stats_top200_en_de_ru_42k.tsv"
